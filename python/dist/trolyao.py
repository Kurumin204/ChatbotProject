...
def get_audio():
    playsound.playsound("C:\\Users\\Hung\\Downloads\\python\\python\\C:\\Users\\Hung\\Downloads\\python\\python\\Ping.mp3", False)
    time.sleep(1)
    print("\nAi:  Đang nghe ...")
...
def hello():
    image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\hacker1.jpg")
...
def get_time(text):
    image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\thoigian.jpg")
    image_1 = ImageTk.PhotoImage(image1)    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
...
def open_application(text):
    image_1 = ImageTk.PhotoImage(Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\trolyao.jpg"))    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
    if "cốc cốc" in text:
...
def weather(text):
    ...
    if "rain" in text:
        image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\thoitiet2.jpg")
        image_1 = ImageTk.PhotoImage(image1)    
        label1 = Label(image=image_1)
        label1.image = image_1
        label1.place(x=7, y=43)
    else :
        image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\thoitiet1.jpg")
        image_1 = ImageTk.PhotoImage(image1)    
        label1 = Label(image=image_1)
        label1.image = image_1
        label1.place(x=7, y=43)
...
def subject(text):
    image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\TKB.jpg")
    image_1 = ImageTk.PhotoImage(image1)    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
...
def get_math():
    ...
    root.update()
    image_1 = ImageTk.PhotoImage(Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\math.jpg"))    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
...
def func():
    image1 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\trolyao.jpg")
    image_1 = ImageTk.PhotoImage(image1)    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
...
def ham_main():
    ...
    while True:
        with speech_recognition.Microphone() as source:
            playsound.playsound("C:\\Users\\Hung\\Downloads\\python\\python\\Ping.mp3", False)
            time.sleep(1)
            print("AI:  Dang nghe ...")
            audio = r.listen(source, phrase_time_limit=6)
            print("AI:  ...")
...
class Example(Frame):
    ...
    def initUI(self):
        ...
        image3 = Image.open("C:\\Users\\Hung\\Downloads\\python\\python\\image\\micro.png")
